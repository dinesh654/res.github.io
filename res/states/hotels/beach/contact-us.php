...
<head>
 ...
 <body>
     <div class="loader"><img src="images/loading.gif" alt="" / ></div>
        ...
        <section>
         <div class="banner">
         <img class="img-responsive logo1" src="images/logo.png"/ width="500" height="100">
    ...
    <div class="container">
         <div class="col-md-6">
             ...
             <div class="contact-details">
                <h4>&nbsp; chili restaurant</h4>
                <ul>
                    <li>opposite to chittoor bus stand</li>
                    <li>chittoor,</li>
                    <li>Andhra Pradesh,</li>
                    <li>India,517001</li>
                    <li>5568464886</a></li>
                    <li><a href="mailto:chili@gmail.com">for mail click here</a></li>
                    <li><a href="www.chili.com" target="_blank">www.chili.com</a></li>
                </ul>
            </div>
        </div>
    <div class="col-md-6">
