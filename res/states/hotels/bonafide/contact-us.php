...
<head>
 ...
 <body>
     <div class="loader"><img src="images/loading.gif" alt="" /></div>
        ...
        <section>
         <div class="banner">
         <img class="img-responsive logo1" src="images/bonafide.jpg"/ width="200" height="100">
		 <center><img src="images/contact.jpg"  class="img-responsive" width="500" height="10"></center>
	</div>
    ...
    <div class="container">
         <div class="col-md-6">
             ...
             <div class="contact-details">
                <h4>&nbsp; Bonafide restaurant</h4>
                <ul>
                    
                    <li>chittoor,</li>
                    <li>Andhra Pradesh,</li>
                    <li>India. Pin: 517001</li>
                    <li>9586452145</a></li>
                    <li><a href="mailto:bistro@gmail.com">bonafide@gmail.com</a></li>
                    <li><a href="http://www.bistro.com" target="_blank">www.bonafide.com</a></li>
                </ul>
            </div>
        </div>
    <div class="col-md-6">
