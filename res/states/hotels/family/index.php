...
<head>
 ...
 <body>
     <div class="loader"><img src="images/loading.gif" alt="" /></div>
        ...
        <section>
        <div class="banner">
            <img class="img-responsive logo" src="images/fishs.jpg"/ width="200" height="200">
                <div class="carousel-inner">
                    <div class="item active">
                        <img alt="First slide" style="visibility: hidden;" src="images/banners.png" />
                        <center><img class=" col-xs-8 sliderimg wow zoomIn img-responsive" data-wow-duration="2s" data-wow-delay="0s" src="images/download2.webp" /></center>
                    </div>
                    <div class="item">
                        <img alt="First slide" style="visibility: hidden;" src="images/banners.png" />
                        <center><img class=" col-xs-8 sliderimg wow zoomIn img-responsive" data-wow-duration="2s" data-wow-delay="0s" src="images/download.jpg" /></center>
                    </div>
                    <div class="item">
                        <img alt="First slide" style="visibility: hidden;" src="images/banners.png" />
                        <center><img class=" col-xs-8 sliderimg wow zoomIn img-responsive" data-wow-duration="2s" data-wow-delay="0s" src="images/downnload2.webp" /></center>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <p>Family restaurant is the soul of southern India and we stand for authentic Indian cuisine. Here at family, our aim is to bring to your table the essence of our rich heritage of taste and culinary culture. Our chefs excel in treating you with the most delectable spread and we have proved ourselves over the years of being the ones to present the same to you in the most outstanding manner. .</p>

<p>Our restaurant has a milieu that is comforting and enjoyable with spacious and sophisticated interiors and service crews that will make you feel special, welcome and relaxed</p>
            </div>
            <div class="col-md-4">
...
<section id="gallery">
    <div class="container">
        ...
        <div class="inner">
            <p>Our asset being our chefs whose skills are par excellence we take pride in declaring that we specialize in both and north and south Indian tastes catering to each of your cravings. Our spread is all you can ask for if you are a lover of vegetarian cuisine. From starters to deserts, here at Sapthagiri you will find a wide variety to choose from. </p>
                <span></span>
            </div>
                 ...
                 <div class="carousel-inner text-center">
                    ...
                    <div class="item">
                        <blockquote>
                            <div class="row">
                                <div class="col-sm-8 col-sm-offset-2">
                                    <p>Just tried the collard wrap for the first time and it was delicious. I special order a few different items through my local health food store and they are weekly staples for lunch and dinner. Love Awesome Foods!!</p>
                                    <small>Denise Wynters</small>
                                </div>
                            </div>
                        </blockquote>
                    </div>
                    ...
                    <div class="item">
                        <blockquote>
                            <div class="row">
                                <div class="col-sm-8 col-sm-offset-2">
                                    <p>I got my large order of Raw Vegan foods in today via UPS and was very impressed with the packaging & freshness as well as the quality of my meals. The Raw Tuna Sandwich was soooo good!! Looking forward to being a REGULAR ordering customer from now on!</p>
                                    <small>Danny Garrisjn</small>
                                </div>
                            </div>
                        </blockquote>
                    </div>
